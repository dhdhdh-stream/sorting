...
void PassThroughExperiment::experiment_verify_existing_backprop(
	...
	if (this->state == PASS_THROUGH_EXPERIMENT_STATE_EXPERIMENT_VERIFY_1ST_EXISTING
		...
		this->state = PASS_THROUGH_EXPERIMENT_STATE_EXPERIMENT_VERIFY_1ST_NEW;
		/**
		...
		this->state = PASS_THROUGH_EXPERIMENT_STATE_EXPERIMENT_VERIFY_2ND_NEW;
		/**
		 * - leave this->state_iter unchanged
		 */
	}
