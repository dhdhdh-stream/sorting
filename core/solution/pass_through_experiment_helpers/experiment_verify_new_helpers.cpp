...
void PassThroughExperiment::experiment_verify_new_backprop(
	...
	if (this->root_state == ROOT_EXPERIMENT_STATE_VERIFY_1ST
		...
		if (score_improvement_t_score > 1.0 && score_improvement_t_score < 1.960) {
			cout << "experiment_verify 1st score_improvement_t_score: " << score_improvement_t_score << endl;
		}
		...
		if (score_improvement_t_score > 1.0 && score_improvement_t_score < 1.960) {
			cout << "experiment_verify 2nd score_improvement_t_score: " << score_improvement_t_score << endl;
		}
