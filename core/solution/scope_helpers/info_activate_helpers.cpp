...
void node_info_activate_helper(AbstractNode*& curr_node,
							   Problem* problem,
...
void Scope::info_activate(Problem* problem,
						  RunHelper& run_helper,
						  ScopeHistory*& history) {
	...
	while (true) {
		...
		node_info_activate_helper(curr_node,
								  problem,
								  inner_context,
								  run_helper,
								  history);
