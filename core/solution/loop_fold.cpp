...
LoopFold::~LoopFold() {
	...
	if (this->state != LOOP_FOLD_STATE_EXPERIMENT_FAIL
		...
		if (this->state != LOOP_FOLD_STATE_REMOVE_OUTER_SCOPE_NETWORK) {	// TODO: find more elegant way of catching this
...
void LoopFold::activate(Problem& problem,
	...
	if (this->state == LOOP_FOLD_STATE_EXPERIMENT
		...
		if (this->sub_state == LOOP_FOLD_SUB_STATE_LEARN) {
			experiment_learn_activate(problem,
									  state_vals,
									  states_initialized,
									  predicted_score,
									  scale_factor,
			...
			experiment_measure_activate(problem,
										state_vals,
										states_initialized,
										predicted_score,
										scale_factor,
		...
		if (this->sub_state == LOOP_FOLD_SUB_STATE_LEARN) {
			remove_inner_input_learn_activate(problem,
											  state_vals,
											  states_initialized,
											  predicted_score,
											  scale_factor,
			...
			remove_inner_input_measure_activate(problem,
												state_vals,
												states_initialized,
												predicted_score,
												scale_factor,
		...
		remove_outer_scope_activate(problem,
									state_vals,
									states_initialized,
									predicted_score,
									scale_factor,
		...
		remove_outer_scope_network_activate(problem,
											state_vals,
											states_initialized,
											predicted_score,
											scale_factor,
