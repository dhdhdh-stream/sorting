...
void BranchNode::random_existing_activate(AbstractNode*& curr_node,
...
void BranchNode::inner_random_existing_activate(AbstractNode*& curr_node,
												vector<Scope*>& scope_context,
												vector<AbstractNode*>& node_context) {
	bool matches_context = true;
	if (this->scope_context.size() > scope_context.size()) {
...
void BranchNode::random_path_activate(AbstractNode*& curr_node,
									  vector<Scope*>& scope_context,
									  vector<AbstractNode*>& node_context) {
	bool matches_context = true;
	if (this->scope_context.size() > scope_context.size()) {
