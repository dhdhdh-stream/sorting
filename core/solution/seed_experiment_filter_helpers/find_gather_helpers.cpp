...
void SeedExperimentFilter::create_gather_activate(Problem* problem,
	...
	// cout << "curr_gather_path:" << endl;
	// for (int s_index = 0; s_index < (int)curr_gather_step_types.size(); s_index++) {
	// 	if (curr_gather_step_types[s_index] == STEP_TYPE_ACTION) {
	// 		cout << " " << curr_gather_actions[s_index]->action.move;
	// 	} else if (curr_gather_step_types[s_index] == STEP_TYPE_EXISTING_SCOPE) {
	// 		cout << " E";
	// 	} else {
	// 		cout << " P";
	// 	}
	...
	// 	ActionNode* new_action_node = new ActionNode();
	// 	// RIGHT
	// 	new_action_node->action = Action(1);
	// 	curr_gather_actions.push_back(new_action_node);
	...
	// 	ActionNode* new_action_node = new ActionNode();
	// 	// DOWN
	// 	new_action_node->action = Action(2);
	// 	curr_gather_actions.push_back(new_action_node);
	...
	if (this->parent->curr_gather != NULL) {
		throw invalid_argument("this->parent->curr_gather != NULL");
	}
	...
	this->parent->curr_gather_miss_count = 0;
