...
void BranchExperiment::experiment_verify_backprop(
	...
	if (this->root_state == ROOT_EXPERIMENT_STATE_VERIFY_1ST
		...
		if (combined_improvement_t_score > 1.0 && combined_improvement_t_score < 1.960) {
			cout << "experiment_verify 1st combined_improvement_t_score: " << combined_improvement_t_score << endl;
		}
		...
		if (combined_improvement_t_score > 1.960) {
			...
			if (chain_distribution(generator) == 0) {
		...
		if (combined_improvement_t_score > 1.0 && combined_improvement_t_score < 1.960) {
			cout << "experiment_verify 2nd combined_improvement_t_score: " << combined_improvement_t_score << endl;
		}
