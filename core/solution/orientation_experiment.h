...
const int ORIENTATION_EXPERIMENT_STATE_VERIFY_EXISTING = 4;
const int ORIENTATION_EXPERIMENT_STATE_VERIFY = 5;
#if defined(MDEBUG) && MDEBUG
const int ORIENTATION_EXPERIMENT_STATE_CAPTURE_VERIFY = 6;
#endif /* MDEBUG */
