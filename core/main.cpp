...
// - cannot rely on being able to complete a billions runs
//   - have to create subgoals/subproblems which can be tackled multiple times even within a single run
//     - hiearchy of goals/problems

// - have to identify what is relevant to final success locally
//   - and has to be robust to experimentation

// - maybe have eval sequence?
//   - good eval sequence has to have minimal final impact while being good at predicting final score

// - maybe eval both before and after
//   - so don't eval explore sequence
//     - intuitively, effects of sequence unpredictable, but can look at the before and after

// - maybe eval sequence per scope
//   - with each based on the layer outside?

// - to determine if eval sequence not significant impact, maybe randomly try everywhere
//   - or at least randomly within its scope

// - can use history
//   - though probably don't include initially
