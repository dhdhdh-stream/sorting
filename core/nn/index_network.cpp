...
IndexNetwork::IndexNetwork(ifstream& input_file) {
	construct();
...
void IndexNetwork::activate(double obs_val,
...
void IndexNetwork::backprop(double error,
							IndexNetworkHistory* history) {
...
void IndexNetwork::save(ofstream& output_file) {
	this->hidden->save_weights(output_file);
	this->output->save_weights(output_file);
}

IndexNetworkHistory::IndexNetworkHistory(IndexNetwork* network) {
	this->network = network;
}

void IndexNetworkHistory::save_weights() {
...
void IndexNetworkHistory::reset_weights() {
