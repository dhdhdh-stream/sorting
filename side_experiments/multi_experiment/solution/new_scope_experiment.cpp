...
void NewScopeExperiment::decrement(AbstractNode* experiment_node) {
	...
	if (is_test) {
		...
		this->test_location_states.erase(this->test_location_states.begin() + location_index);
		this->test_location_existing_scores.erase(this->test_location_existing_scores.begin() + location_index);
		this->test_location_existing_counts.erase(this->test_location_existing_counts.begin() + location_index);
		this->test_location_new_scores.erase(this->test_location_new_scores.begin() + location_index);
		this->test_location_new_counts.erase(this->test_location_new_counts.begin() + location_index);
	} else {
