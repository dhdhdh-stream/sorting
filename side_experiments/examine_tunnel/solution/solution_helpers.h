...
Tunnel* create_obs_candidate(std::vector<std::vector<double>>& obs_histories,
...
void measure_tunnel_val(std::vector<std::vector<double>>& obs_histories,
						Tunnel* tunnel,
						double& val_average,
						double& val_standard_deviation);
void retrain_and_compare(std::vector<std::vector<double>>& obs_histories,
						 std::vector<double>& target_val_histories,
						 Tunnel* tunnel);
