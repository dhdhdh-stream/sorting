...
void Scope::save(ofstream& output_file) {
	...
	output_file << (this->signal_experiment == NULL) << endl;
	if (this->signal_experiment != NULL) {
		this->signal_experiment->save(output_file);
	}
}
...
void Scope::load(ifstream& input_file,
	...
	string signal_experiment_is_null_line;
	getline(input_file, signal_experiment_is_null_line);
	bool signal_experiment_is_null = stoi(signal_experiment_is_null_line);
	if (signal_experiment_is_null) {
		this->signal_experiment = NULL;
	} else {
		this->signal_experiment = new SignalExperiment(input_file);
	}
}
