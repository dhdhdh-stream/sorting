 ...
 * - can work
 * 
 * - kind of still want to stabilize occasionally?
 * 
 * - issue is that value gets too big
 *   - can't easily undo it without making things unstable?
 * 
 * - issue is not number of weights
 * - issue is not update rate remaining too high
 *   - in fact, lowering makes things worse
 * 
