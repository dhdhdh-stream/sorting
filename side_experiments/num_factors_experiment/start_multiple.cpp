// TODO: try simply using action count to stabilize initially
// - doesn't really work

// TODO: maybe somehow create factors, and add to state, and set to 1 initially
...
int main(int argc, char* argv[]) {
	...
	// Network* context_network = new Network(SIGMOID_LAYER, 5, 1);
	Network* context_network = new Network(LEAKY_LAYER, 6, 2);
	// Network* network = new Network(SIGMOID_LAYER, 1, 1);
