...
int main(int argc, char* argv[]) {
	...
	for (int iter_index = 0; iter_index < 100000; iter_index++) {
		...
		if ((iter_index+1)%20 == 0) {
			...
			obs_network_1->get_max_update(max_update);
			obs_network_2->get_max_update(max_update);
			obs_network_3->get_max_update(max_update);
			obs_network_4->get_max_update(max_update);
