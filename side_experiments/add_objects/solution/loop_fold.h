...
public:
	...
	void experiment_learn_inner_scope_activate_helper(
		...
		int step_index,
		LoopFoldHistory* history);
	void experiment_learn_activate(std::vector<double>& state_vals,
								   std::vector<bool>& states_initialized,
								   std::vector<std::vector<double>>& flat_vals,
								   double& predicted_score,
								   double& scale_factor,
	...
	void experiment_measure_inner_scope_activate_helper(
		...
		std::vector<int>& curr_node_context,
		RunHelper& run_helper);
	void experiment_measure_activate(std::vector<double>& state_vals,
									 std::vector<bool>& states_initialized,
									 std::vector<std::vector<double>>& flat_vals,
									 double& predicted_score,
									 double& scale_factor,
	...
	void remove_inner_input_learn_inner_scope_activate_helper(
		...
		int step_index,
		LoopFoldHistory* history);
	void remove_inner_input_learn_activate(std::vector<double>& state_vals,
										   std::vector<bool>& states_initialized,
										   std::vector<std::vector<double>>& flat_vals,
										   double& predicted_score,
										   double& scale_factor,
	...
	void remove_inner_input_measure_inner_scope_activate_helper(
		...
		std::vector<int>& curr_node_context,
		RunHelper& run_helper);
	void remove_inner_input_measure_activate(std::vector<double>& state_vals,
											 std::vector<bool>& states_initialized,
											 std::vector<std::vector<double>>& flat_vals,
											 double& predicted_score,
											 double& scale_factor,
	...
	void remove_outer_scope_activate(std::vector<double>& state_vals,
									 std::vector<bool>& states_initialized,
									 std::vector<std::vector<double>>& flat_vals,
									 double& predicted_score,
									 double& scale_factor,
	...
	void remove_outer_scope_network_inner_scope_activate_helper(
		...
		int step_index,
		LoopFoldHistory* history);
	void remove_outer_scope_network_activate(std::vector<double>& state_vals,
											 std::vector<bool>& states_initialized,
											 std::vector<std::vector<double>>& flat_vals,
											 double& predicted_score,
											 double& scale_factor,
	...
	void clean_inner_scope_activate_helper(std::vector<double>& new_state_vals,
										   ...
										   std::vector<double>& test_new_state_vals,
										   std::vector<std::vector<std::vector<std::vector<StateNetworkHistory*>>>>& test_inner_state_network_histories);
	void clean_activate(std::vector<double>& state_vals,
						std::vector<bool>& states_initialized,
						std::vector<std::vector<double>>& flat_vals,
						double& predicted_score,
						double& scale_factor,
