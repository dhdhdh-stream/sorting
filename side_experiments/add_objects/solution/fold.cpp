...
void Fold::sequence_activate(vector<double>& state_vals,
	...
	if (this->state == FOLD_STATE_EXPERIMENT
			|| this->state == FOLD_STATE_ADD_OUTER_STATE
			|| this->state == FOLD_STATE_ADD_INNER_STATE) {
		experiment_sequence_activate(state_vals,
									 states_initialized,
									 flat_vals,
									 predicted_score,
									 scale_factor,
		...
		remove_inner_input_sequence_activate(state_vals,
											 states_initialized,
											 flat_vals,
											 predicted_score,
											 scale_factor,
		...
		remove_outer_scope_sequence_activate(state_vals,
											 states_initialized,
											 flat_vals,
											 predicted_score,
											 scale_factor,
		...
		remove_outer_scope_network_sequence_activate(state_vals,
													 states_initialized,
													 flat_vals,
													 predicted_score,
													 scale_factor,
		...
		clean_sequence_activate(state_vals,
								states_initialized,
								flat_vals,
								predicted_score,
								scale_factor,
