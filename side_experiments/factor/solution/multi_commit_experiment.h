#ifndef MULTI_COMMIT_EXPERIMENT_H
#define MULTI_COMMIT_EXPERIMENT_H
...
const int MULTI_COMMIT_EXPERIMENT_STATE_EXISTING_GATHER = 0;
const int MULTI_COMMIT_EXPERIMENT_STATE_TRAIN_EXISTING = 1;
const int MULTI_COMMIT_EXPERIMENT_STATE_EXPLORE = 2;
const int MULTI_COMMIT_EXPERIMENT_STATE_FIND_SAVE = 3;
const int MULTI_COMMIT_EXPERIMENT_STATE_COMMIT_EXISTING_GATHER = 4;
const int MULTI_COMMIT_EXPERIMENT_STATE_COMMIT_TRAIN_EXISTING = 5;
...
public:
	...
	MultiCommitExperiment(Scope* scope_context,
						  AbstractNode* node_context,
						  bool is_branch);
	~MultiCommitExperiment();
	...
	void commit_existing_gather_activate(AbstractNode*& curr_node,
										 ...
										 ScopeHistory* scope_history,
										 MultiCommitExperimentHistory* history);
	void commit_existing_gather_backprop(MultiCommitExperimentHistory* history);
	...
	void commit_new_gather_activate(AbstractNode*& curr_node,
									...
									ScopeHistory* scope_history,
									MultiCommitExperimentHistory* history);
	void commit_new_gather_backprop(MultiCommitExperimentHistory* history);
...
class MultiCommitExperimentHistory : public AbstractExperimentHistory {
public:
	bool is_active;
	...
	MultiCommitExperimentHistory(MultiCommitExperiment* experiment);
};

#endif /* MULTI_COMMIT_EXPERIMENT_H */