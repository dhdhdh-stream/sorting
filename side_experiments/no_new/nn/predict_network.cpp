...
PredictNetwork::PredictNetwork(int num_states) {
	...
	this->dist_hidden_1->update_structure();
	...
	this->dist_hidden_2->update_structure();
	...
	this->mean_output->update_structure();
	...
	this->deviation_output->update_structure();
