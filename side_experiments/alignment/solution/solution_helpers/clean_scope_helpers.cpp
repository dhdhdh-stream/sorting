		...
		case NODE_TYPE_ACTION:
			{
				...
				if (action_node->next_node == NULL
						|| action_node->next_node->type != NODE_TYPE_OBS
		...
		case NODE_TYPE_SCOPE:
			{
				...
				if (scope_node->next_node == NULL
						|| scope_node->next_node->type != NODE_TYPE_OBS
		...
		case NODE_TYPE_BRANCH:
			{
				...
				if (branch_node->original_next_node == NULL
						|| branch_node->original_next_node->type != NODE_TYPE_OBS
				...
				if (branch_node->branch_next_node == NULL
						|| branch_node->branch_next_node->type != NODE_TYPE_OBS
