...
void CommitExperiment::add() {
	...
	new_branch_node->average_val = this->commit_existing_average_score;
	new_branch_node->factor_ids = this->commit_existing_factor_ids;
	new_branch_node->factor_weights = this->commit_existing_factor_weights;
