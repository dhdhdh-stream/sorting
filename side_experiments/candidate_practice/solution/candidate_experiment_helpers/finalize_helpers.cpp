...
// void CandidateExperiment::clean() {
// 	this->node_context->experiment = NULL;
// }

// void CandidateExperiment::add(SolutionWrapper* wrapper) {
// 	stringstream ss;
// 	ss << "CandidateExperiment" << "; ";
...
// 	new_branch_node->val_network = this->new_signal_network;
...
// 	this->scope_context->tunnels.push_back(this->candidate);
// 	wrapper->curr_tunnel_parent = this->scope_context;
// 	wrapper->curr_tunnel_index = this->scope_context->tunnels.size()-1;
// 	this->candidate = NULL;
// }

// double CandidateExperiment::calc_new_score() {
