...
void CandidateExperiment::capture_verify_check_activate(
...
void CandidateExperiment::capture_verify_step(vector<double>& obs,
											  int& action,
											  bool& is_next,
											  SolutionWrapper* wrapper) {
...
void CandidateExperiment::capture_verify_backprop(SolutionWrapper* wrapper) {
