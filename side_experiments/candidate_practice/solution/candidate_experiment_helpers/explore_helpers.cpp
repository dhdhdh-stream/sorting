...
// void CandidateExperiment::explore_check_activate(SolutionWrapper* wrapper) {
...
// void CandidateExperiment::explore_step(vector<double>& obs,
// 									   int& action,
// 									   bool& is_next,
// 									   bool& fetch_action,
...
// void CandidateExperiment::explore_set_action(int action,
// 											 SolutionWrapper* wrapper) {
// 	CandidateExperimentState* experiment_state = (CandidateExperimentState*)wrapper->experiment_context.back();
...
// void CandidateExperiment::explore_backprop(double target_val,
// 										   SolutionWrapper* wrapper) {
// 	CandidateExperimentHistory* history = (CandidateExperimentHistory*)wrapper->experiment_history;
...
// 		double signal = this->candidate->get_signal(history->stack_traces[0].back()->obs_history);
...
// 			#endif /* MDEBUG */
// 				this->state = CANDIDATE_EXPERIMENT_STATE_TRAIN_NEW;
// 				this->state_iter = 0;
// 			} else {
