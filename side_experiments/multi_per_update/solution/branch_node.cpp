...
void BranchNode::copy_from(BranchNode* original,
	...
	this->just_added = original->just_added;
...
void BranchNode::save(ofstream& output_file) {
	...
	output_file << this->just_added << endl;
...
void BranchNode::load(ifstream& input_file,
	...
	string just_added_line;
	getline(input_file, just_added_line);
	this->just_added = stoi(just_added_line);
