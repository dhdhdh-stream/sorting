...
public:
	...
	std::vector<std::vector<int>> existing_dependencies_new_state_norms_histories;
	std::vector<std::vector<Eigen::VectorXf>> existing_dependencies_state_norms_histories;
	...
	std::vector<int> existing_new_state_norms_histories;
	std::vector<Eigen::VectorXf> existing_state_norms_histories;
	std::vector<Eigen::VectorXf> existing_state_histories;
	std::vector<double> existing_target_val_histories;

	std::vector<std::vector<bool>> new_dependencies_is_hit_histories;
	std::vector<std::vector<int>> new_dependencies_new_state_norms_histories;
	std::vector<std::vector<Eigen::VectorXf>> new_dependencies_state_norms_histories;
	...
	std::vector<int> new_new_state_norms_histories;
	std::vector<Eigen::VectorXf> new_state_norms_histories;
...
public:
	...
	std::vector<std::vector<int>> dependencies_new_state_norms_histories;
	std::vector<std::vector<Eigen::VectorXf>> dependencies_state_norms_histories;
	...
	std::vector<int> new_state_norms_histories;
	std::vector<Eigen::VectorXf> state_norms_histories;
