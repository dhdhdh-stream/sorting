...
LoopFold::LoopFold(vector<int> scope_context,
	...
	this->num_local_states = scope->num_local_states;
	this->num_input_states = scope->num_input_states;
...
void LoopFold::activate(vector<double>& local_state_vals,
						vector<double>& input_vals,
						vector<vector<double>>& flat_vals,
						double& predicted_score,
						double& scale_factor,
	...
	if (this->state == LOOP_FOLD_STATE_REMOVE_OUTER_SCOPE) {
		...
		remove_outer_scope_network_activate(local_state_vals,
											input_vals,
											flat_vals,
											predicted_score,
											scale_factor,
		...
		remove_inner_scope_activate(local_state_vals,
									input_vals,
									flat_vals,
									predicted_score,
									scale_factor,
		...
		remove_inner_scope_network_activate(local_state_vals,
											input_vals,
											flat_vals,
											predicted_score,
											scale_factor,
