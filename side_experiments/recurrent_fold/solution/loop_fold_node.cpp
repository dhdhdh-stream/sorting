...
void LoopFoldNode::activate(vector<double>& local_state_vals,
	...
	if (matches_context) {
		...
		this->loop_fold->activate(local_state_vals,
								  input_vals,
								  flat_vals,
								  predicted_score,
								  scale_factor,
...
void LoopFoldNode::backprop(vector<double>& local_state_errors,
	...
	if (history->loop_fold_history != NULL) {
		this->loop_fold->backprop(local_state_errors,
								  input_errors,
								  target_val,
								  final_misguess,
								  final_sum_impact,
