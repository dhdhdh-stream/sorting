/**
 * Note: unable to compress early because fold no longer directly
 * depends on score. (I.e., before choice, score_modifier doesn't
 * 100% tie to final_val.)
 * 
 * 0 - 2: blank
...
int main(int argc, char* argv[]) {
	...
	// for (int iter_index = 1; iter_index < 10000; iter_index++) {
	// 	int choice_val = 0;
	// 	int xor_val = 0;
	// 	double score_modifier = 0.0;
	...
	// 	average_score += final_val;
	// 	average_error += abs(final_val - initial_fold_network->output->acti_vals[0]);
	// }

	// cout << "average_score: " << average_score/10000 << endl;
