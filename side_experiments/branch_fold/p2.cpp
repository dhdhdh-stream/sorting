/**
 * 0 - 2: blank
 * 1 - 2: 1 which is 1st xor mult factor
 * 2 - 3: 2 which are 1st xor
 * 3 - 2: 1 which is 1st xor
 * 4 - 3: blank
 * 5 - 4: 1 which is 1st xor
 * 6 - 1: blank
 * 7 - 1: 1 which is 2nd xor mult factor
 * 8 - 3: 1 which is 2nd xor
 * 9 - 2: 2 which is 2nd xor
 * 10 - 3: blank
 * 11 - 2: 1 which is 2nd xor
 * 12 - 2: blank
 */
...
int main(int argc, char* argv[]) {
	...
	// 		flat_vals.push_back(vector<double>(2));
	// 		flat_vals[1][0] = rand()%4;
	// 		int first_factor = (int)flat_vals[1][0];
	...
	// 		flat_vals.push_back(vector<double>(1));
	// 		flat_vals[7][0] = rand()%4;
	// 		int second_factor = (int)flat_vals[7][0];
	...
	// 		double final_val = first_sum%2*first_factor - second_sum%2*second_factor;
	...
	for (int compress_index = fold_index; compress_index < 13; compress_index++) {
