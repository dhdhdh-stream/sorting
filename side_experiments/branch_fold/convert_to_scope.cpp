...
int main(int argc, char* argv[]) {
	...
	// 	cout << sc_index << ": " << scope_dictionary[sc_index]->actions.size() << endl;
	// 	cout << "input_size: " << scope_dictionary[sc_index]->num_inputs << endl;
	// 	cout << "output_size: " << scope_dictionary[sc_index]->num_outputs << endl;
	// }
