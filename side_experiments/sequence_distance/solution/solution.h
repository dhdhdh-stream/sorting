// - for saving failures:
//   - save score variance + misguess
//     - so potential for good score + ability to know when
//       - also capture when information was captured
//     - perhaps save max too
//       - top 1%, 5%, 10%
// - also when run was done
//   - i.e., how many successes ago
