...
// - maybe if split greatly reduces variance, then is meaningful?

// - realistically, shouldn't go past like 5 possibilities anyways
//   - so should maybe just initialize to 5
...
int main(int argc, char* argv[]) {
	...
	for (int iter_index = 0; iter_index < TRAIN_ITERS; iter_index++) {
		...
		for (int d_index = 0; d_index < NUM_DIMENSIONS; d_index++) {
			target_val[d_index] = -5 + 10 * target_distribution(generator);
		}
