...
const int NEW_ACTION_VERIFY_1ST_NUM_DATAPOINTS = 25;
const int NEW_ACTION_VERIFY_1ST_TRUTH_NUM_DATAPOINTS = 10;
const int NEW_ACTION_VERIFY_2ND_NUM_DATAPOINTS = 100;
const int NEW_ACTION_VERIFY_2ND_TRUTH_NUM_DATAPOINTS = 25;
#endif /* MDEBUG */
