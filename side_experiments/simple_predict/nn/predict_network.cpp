...
PredictNetwork::PredictNetwork(ifstream& input_file) {
	this->state_input = new Layer(LINEAR_LAYER);
...
void PredictNetwork::save(PredictNetworkHistory* history) {
...
void PredictNetwork::load(PredictNetworkHistory* history) {
...
void PredictNetwork::backprop(Eigen::VectorXf& state_errors) {
