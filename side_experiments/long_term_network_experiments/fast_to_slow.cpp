// - target initial solve 10% into 1% going long
...
int main(int argc, char* argv[]) {
...

	{
		...
		cout << "pre long sum_misguess: " << sum_misguess << endl;
	}

	for (int iter_index = 0; iter_index < 700000; iter_index++) {
		vector<double> inputs(NUM_INPUTS);
		for (int i_index = 0; i_index < NUM_INPUTS; i_index++) {
			inputs[i_index] = input_distribution(generator);
		}
...

	{
		...
		cout << "post long sum_misguess: " << sum_misguess << endl;
	}
