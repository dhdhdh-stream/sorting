...
public:
	...
	void explore_result_check_activate(SolutionWrapper* wrapper);
	void explore_result_backprop(SolutionWrapper* wrapper);
	...
	void measure_result_check_activate(SolutionWrapper* wrapper);
