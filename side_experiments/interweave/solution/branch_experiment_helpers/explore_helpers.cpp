...
void BranchExperiment::explore_backprop(
	...
	if (curr_surprise > this->best_surprise) {
		...
		this->best_step_types = instance_history->curr_step_types;
		this->best_actions = instance_history->curr_actions;
		this->best_scopes = instance_history->curr_scopes;
		this->best_exit_next_node = instance_history->curr_exit_next_node;
	}
...
void BranchExperiment::explore_update() {
	...
	if (this->run_iter >= BRANCH_EXPERIMENT_EXPLORE_ITERS) {
