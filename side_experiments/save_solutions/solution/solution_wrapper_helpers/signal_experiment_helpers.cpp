...
void SolutionWrapper::signal_experiment_init() {
	...
	ScopeHistory* scope_history = new ScopeHistory(this->solutions[
		this->signal_experiment->solution_index]->scopes[0]);
	this->scope_histories.push_back(scope_history);
	this->node_context.push_back(this->solutions[
		this->signal_experiment->solution_index]->scopes[0]->nodes[0]);
...
void SolutionWrapper::signal_experiment_set_action(int action) {
	AbstractExperiment* experiment = this->experiment_context.back()->experiment;
