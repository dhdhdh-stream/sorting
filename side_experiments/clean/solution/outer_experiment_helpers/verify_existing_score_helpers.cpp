...
void OuterExperiment::verify_existing_score_backprop(
		double target_val,
		RunHelper& run_helper) {
	...
	if (this->state == OUTER_EXPERIMENT_STATE_VERIFY_1ST_EXISTING_SCORE
		...
		this->state = OUTER_EXPERIMENT_STATE_VERIFY_1ST_NEW_SCORE;
		this->state_iter = 0;
		...
		this->state = OUTER_EXPERIMENT_STATE_VERIFY_2ND_NEW_SCORE;
		this->state_iter = 0;
	}
}
