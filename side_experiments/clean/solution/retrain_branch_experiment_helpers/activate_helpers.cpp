	...
	if (is_selected) {
		...
		case RETRAIN_BRANCH_EXPERIMENT_STATE_MEASURE:
			measure_activate(is_branch,
							 ...
							 run_helper);
			break;
		case RETRAIN_BRANCH_EXPERIMENT_STATE_1ST_VERIFY_EXISTING:
		case RETRAIN_BRANCH_EXPERIMENT_STATE_2ND_VERIFY_EXISTING:
			verify_existing_activate(is_branch,
									 context,
									 run_helper);
			break;
		case RETRAIN_BRANCH_EXPERIMENT_STATE_1ST_VERIFY:
		case RETRAIN_BRANCH_EXPERIMENT_STATE_2ND_VERIFY:
