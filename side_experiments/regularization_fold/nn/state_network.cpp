...
void StateNetwork::update_lasso_weights(int new_furthest_distance) {
	...
	this->lasso_weights[0] = vector<double>{(new_furthest_distance-1)*0.02 + DEFAULT_LASSO_WEIGHT};
	...
	for (int s_index = 0; s_index < NUM_NEW_STATES; s_index++) {
		this->lasso_weights[2][s_index] = (new_furthest_distance-1)*0.02 + DEFAULT_NEW_STATE_LASSO_WEIGHTS[s_index];
	}
	this->lasso_weights[3] = vector<double>(this->new_input_size, (new_furthest_distance-1)*0.02 + DEFAULT_LASSO_WEIGHT);
}
