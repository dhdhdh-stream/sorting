...
// - maybe trickiest is unbalanced dual with multiple possibilities
...
int main(int argc, char* argv[]) {
	...
	for (int iter_index = 0; iter_index < 3000000; iter_index++) {
		double base = -1.5 + base_distribution(generator);
		...
		double noise_1 = 0.1 * in_standard_deviation * noise_distribution(generator);
		// double noise_1 = 0.05 * in_standard_deviation * noise_distribution(generator);
		...
		// double noise_2 = 0.1 * in_standard_deviation * noise_distribution(generator);
		...
		// double noise_3 = 0.2 * in_standard_deviation * noise_distribution(generator);
		...
		// double noise_4 = 0.4 * in_standard_deviation * noise_distribution(generator);
