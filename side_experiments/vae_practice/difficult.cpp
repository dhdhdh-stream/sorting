// - if noise too small, normal distribution will often be in unfamiliar territory
//   - leads to bad results

// - because of the dual predict, predicting pair will only succeed probabilistically
//   - so should still have latent?
...
int main(int argc, char* argv[]) {
	...
	double end_mean_0 = 0.0;
	double end_variance_0 = 1.0;
	double in_mean_1 = 0.0;
	double in_variance_1 = 1.0;
	double end_mean_1 = 0.0;
	double end_variance_1 = 1.0;
	...
	for (int iter_index = 0; iter_index < 3000000; iter_index++) {
		...
		// double noise_1_0 = 0.05 * in_standard_deviation_0 * noise_distribution(generator);
		double noise_1_0 = 0.025 * in_standard_deviation_0 * noise_distribution(generator);
		...
		// double noise_1_1 = 0.05 * in_standard_deviation_1 * noise_distribution(generator);
		double noise_1_1 = 0.025 * in_standard_deviation_1 * noise_distribution(generator);
		double base_1_1 = base_1 + noise_1_1;

		// double noise_2_0 = 0.2 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_2_0 = 0.4 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_2_0 = 0.1 * in_standard_deviation_0 * noise_distribution(generator);
		double noise_2_0 = 0.1 * in_standard_deviation_0 * noise_distribution(generator);
		double base_2_0 = base_1_0 + noise_2_0;
		// double noise_2_1 = 0.2 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_2_1 = 0.4 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_2_1 = 0.1 * in_standard_deviation_1 * noise_distribution(generator);
		double noise_2_1 = 0.1 * in_standard_deviation_1 * noise_distribution(generator);
		double base_2_1 = base_1_1 + noise_2_1;

		// double noise_3_0 = 0.4 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_3_0 = 0.8 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_3_0 = 0.2 * in_standard_deviation_0 * noise_distribution(generator);
		double noise_3_0 = 0.4 * in_standard_deviation_0 * noise_distribution(generator);
		double base_3_0 = base_2_0 + noise_3_0;
		// double noise_3_1 = 0.4 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_3_1 = 0.8 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_3_1 = 0.2 * in_standard_deviation_1 * noise_distribution(generator);
		double noise_3_1 = 0.4 * in_standard_deviation_1 * noise_distribution(generator);
		double base_3_1 = base_2_1 + noise_3_1;

		// double noise_4_0 = 0.8 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_4_0 = 1.6 * in_standard_deviation_0 * noise_distribution(generator);
		// double noise_4_0 = 0.4 * in_standard_deviation_0 * noise_distribution(generator);
		double noise_4_0 = 1.6 * in_standard_deviation_0 * noise_distribution(generator);
		double base_4_0 = base_3_0 + noise_4_0;
		// double noise_4_1 = 0.8 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_4_1 = 1.6 * in_standard_deviation_1 * noise_distribution(generator);
		// double noise_4_1 = 0.4 * in_standard_deviation_1 * noise_distribution(generator);
		double noise_4_1 = 1.6 * in_standard_deviation_1 * noise_distribution(generator);
		double base_4_1 = base_3_1 + noise_4_1;

		end_mean_0 = 0.999*end_mean_0 + 0.001*base_4_0;
		double end_curr_variance_0 = (base_4_0 - end_mean_0) * (base_4_0 - end_mean_0);
		end_variance_0 = 0.999*end_variance_0 + 0.001*end_curr_variance_0;
		end_mean_1 = 0.999*end_mean_1 + 0.001*base_4_1;
		double end_curr_variance_1 = (base_4_1 - end_mean_1) * (base_4_1 - end_mean_1);
		end_variance_1 = 0.999*end_variance_1 + 0.001*end_curr_variance_1;
		...
		if (noise_direction_4_0 >= 1.0) {
			predicted_base_3_0 = base_4_0 - positive_noise_4_0;
		} else if (noise_direction_4_0 <= -1.0) {
			predicted_base_3_0 = base_4_0 - negative_noise_4_0;
		} else {
		...
		if (noise_direction_4_1 >= 1.0) {
			predicted_base_3_1 = base_4_1 - positive_noise_4_1;
		} else if (noise_direction_4_1 <= -1.0) {
			predicted_base_3_1 = base_4_1 - negative_noise_4_1;
		} else {
			double rand_val = direction_distribution(generator);
		...
		if ((iter_index + 1) % 100000 == 0) {
			...
			cout << "base_4_0: " << base_4_0 << endl;
			cout << "base_4_1: " << base_4_1 << endl;
	...
	double in_standard_deviation_0 = sqrt(in_variance_0);
	double end_standard_deviation_0 = sqrt(end_variance_0);
	double in_standard_deviation_1 = sqrt(in_variance_1);
	double end_standard_deviation_1 = sqrt(end_variance_1);
	...
	cout << "end_mean_0: " << end_mean_0 << endl;
	cout << "end_variance_0: " << end_variance_0 << endl;
	cout << "end_standard_deviation_0: " << end_standard_deviation_0 << endl;
	...
	cout << "end_mean_1: " << end_mean_1 << endl;
	cout << "end_variance_1: " << end_variance_1 << endl;
	cout << "end_standard_deviation_1: " << end_standard_deviation_1 << endl;

	normal_distribution<double> init_end_distribution_0(end_mean_0, end_standard_deviation_0);
	normal_distribution<double> init_end_distribution_1(end_mean_1, end_standard_deviation_1);
	for (int iter_index = 0; iter_index < 40; iter_index++) {
		...
		double start_0 = init_end_distribution_0(generator);
		cout << "start_0: " << start_0 << endl;
		double start_1 = init_end_distribution_1(generator);
