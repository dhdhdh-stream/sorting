// - uniform distribution makes things kind of weird
//   - anything in range of both gets pushed to center
...
int main(int argc, char* argv[]) {
	...
	for (int iter_index = 0; iter_index < 10000000; iter_index++) {
		// double base = -10 + 20 * base_distribution(generator);
		double base = -5 + 10 * base_distribution(generator);
