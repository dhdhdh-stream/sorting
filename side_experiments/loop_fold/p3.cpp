...
int main(int argc, char* argv[]) {
	...
	// 															loop_state_size);
	// FoldLoopNetwork* loop_network = new FoldLoopNetwork(pre_loop_flat_sizes,
	// 													loop_flat_sizes,
	// 													loop_state_size);
	
	// // vector<int> flat_sizes{1, 2, 1};
	// vector<int> flat_sizes{1, 3, 1};
	// FoldNetwork* combine_network = new FoldNetwork(flat_sizes);
	...
	// 				loop_network->activate(pre_loop_flat_vals,
	// 									   loop_flat_vals,
	// 									   loop_state,
	// 									   network_historys);
	...
	// 		vector<vector<double>> combine_inputs{
	// 			vector<double>{(double)rand_non_empty},
	// 			// vector<double>{loop_state[0], loop_state[1]},
	// 			vector<double>{loop_state[0], loop_state[1], loop_state[2]},
	// 			vector<double>{(double)add_third_value}};
	// 		combine_network->activate(combine_inputs);
	...
	// 		for (int s_index = 0; s_index < loop_state_size; s_index++) {
	// 			loop_state_errors.push_back(combine_network->flat_inputs[1]->errors[s_index]);
	// 			combine_network->flat_inputs[1]->errors[s_index] = 0.0;
	// 		}
	...
	FoldNetwork* combine_network = new FoldNetwork(combine_input_file);
