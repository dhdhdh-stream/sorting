...
void ExploreExperiment::single_measure_check_activate(vector<double>& obs,
...
void ExploreExperiment::single_measure_step(vector<double>& obs,
											int& action,
											bool& is_next,
											SolutionWrapper* wrapper) {
...
void ExploreExperiment::single_measure_exit_step(SolutionWrapper* wrapper) {
...
void ExploreExperiment::single_measure_backprop(double target_val,
												ExploreExperimentHistory* history,
												SolutionWrapper* wrapper,
												bool& is_add) {
	if (wrapper->diversity_index == this->diversity_index) {
