...
int main(int argc, char* argv[]) {
	...
	int starting_num_scopes = (int)solution_wrapper->solution->scopes.size();
	...
	delete solution_wrapper->prev_solution;
	solution_wrapper->prev_solution = new Solution(solution_wrapper->solution);
